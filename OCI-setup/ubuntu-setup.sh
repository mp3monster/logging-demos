...
echo 'export oci-logging-label-inclusion=$demo$/Fluentd/oci-logging-label-inclusion.conf' >> ~/demo-env.sh
echo 'export opensearch-label-inclusion=$demo$/Fluentd/oci-opensearch-label-inclusion.conf' >> ~/demo-env.sh
echo 'export oci-logging-route-inclusion=$demo$/Fluentd/oci-logging-route-inclusion.conf' >> ~/demo-env.sh
echo 'export opensearch-route-inclusion=$demo$/Fluentd/opensearch-route-inclusion.conf' >> ~/demo-env.sh
echo ' ' >> ~/demo-env.sh
echo '# export oci-logging-label-inclusion=$demo$/Fluentd/dummy-inclusion.conf' >> ~/demo-env.sh
echo '# export opensearch-label-inclusion=$demo$/fluentd/dummy-inclusion.conf' >> ~/demo-env.sh
echo '# export opensearch-label-inclusion=$demo$/fluentd/dummy-inclusion.conf' >> ~/demo-env.sh
echo '# export opensearch-route-inclusion=$demo$/Fluentd/dummy-inclusion.conf' >> ~/demo-env.sh
echo '# export oci-logging-route-inclusion=$demo$/Fluentd/dummy-inclusion.conf' >> ~/demo-env.sh
